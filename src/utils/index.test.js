import {groupTimeSlotsByDay, transformRawData} from './index';
...
describe('Time slots data processing', () => {
  it('Should return data sorted and grouped by day', () => {
    console.log('-=====');
    expect(groupTimeSlotsByDay(transformRawData(mockData[0]).timeSlots)).toEqual({});
  });
});
